...
The system SHALL support theme definitions that specify visual styling properties for photobook pages.

#### Scenario: Theme file format
- **WHEN** system loads a theme
- **THEN** theme file contains properties for backgrounds, borders, spacing, and colors
